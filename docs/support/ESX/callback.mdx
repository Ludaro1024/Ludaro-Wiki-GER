---
sidebar_position: 2
title: Wie Benutzt man einen ESX Callback?
sidebar_label: Wie Benutzt man einen ESX Callback?
---
...
```lua
ESX.RegisterServerCallback('teamchat:getGroup', function(source, cb) -- In diese Klammern kannst du etwas einfügen, wenn du vom Client etwas zum Server sendest. Für dieses Beispiel benötigen wir das nicht.
