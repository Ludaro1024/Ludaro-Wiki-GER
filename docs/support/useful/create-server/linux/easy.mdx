---
sidebar_position: 1
title: FiveM-Server aufsetzen mit einem Script (EINFACH)
sidebar_label: FiveM-Server aufsetzen mit einem Script (EINFACH)
---
...
```bash
curl -s https://raw.githubusercontent.com/Twe3x/fivem-installer/main/setup.sh | bash
```
