...
Sobald du XAMPP installiert hast starte es und klicke auf "MYSQL" und "Apache" und wähle "Start", dann warte, bis beide Dienste gestartet sind.
...
:::info 
Wichtig! Da dies deine Datenbank ist, muss sie **immer** gestartet sein, bevor du deinen Server startest. Öffne einfach XAMPP und starte MySQL und Apache. 🙂
:::
