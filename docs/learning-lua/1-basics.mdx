...
- **Linux:** Folge dieser Anleitung für einen [Testserver auf Linux](easy.mdx).
- **Windows (eigener PC):** Nutze diese Anleitung, um einen [Testserver auf deinem eigenen PC](ownpc.mdx) einzurichten.
- **Windows (Server):** Für einen [Testserver auf einem dedizierten Windows-Server](server.mdx), schaue dir diese Anleitung an.
